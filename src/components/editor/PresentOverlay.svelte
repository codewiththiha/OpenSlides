<script lang="ts">
  ...
  import HighlightStepIndicator from "../HighlightStepIndicator.svelte";
  import ProgressBar from "../ui/ProgressBar.svelte";
  import AutoplayTimerChip from "../presentation/AutoplayTimerChip.svelte";
  import PresentControls from "../presentation/PresentControls.svelte";
  import { ui, toggleAutoPlaying, setIsAutoPlaying } from "@/store/ui-state.svelte";
